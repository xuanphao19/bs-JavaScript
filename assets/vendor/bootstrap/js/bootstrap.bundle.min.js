  ...
  const he = {
    ...
    fn: function (t) {
      ...
      if (o && r) {
        var h = (function (t, e) {
            return le(
              'number' != typeof (t = 'function' == typeof t ? t(Object.assign({}, e.rects, { placement: e.placement })) : t) ? t : ce(t, yt)
            );
          })(s.padding, i),
          d = Jt(o),
          u = 'y' === l ? gt : bt,
      ...
      w = (function (t, e, i, n) {
        var s =
          ...
          a = o.reduce(function (e, i) {
            var s = xe(t, i, n);
            return (
              (e.top = Kt(s.top, e.top)), (e.right = Qt(s.right, e.right)), (e.bottom = Qt(s.bottom, e.bottom)), (e.left = Kt(s.left, e.left)), e
            );
          }, xe(t, r, n));
        ...
        for (
          var s = i.mainAxis,
            ...
            v = [m].concat(b).reduce(function (t, i) {
              return t.concat(
                Vt(i) === vt ? De(e, { placement: i, boundary: h, rootBoundary: d, padding: c, flipVariations: p, allowedAutoPlacements: g }) : i
              );
            }, []),
            y = e.rects.reference,
            w = e.rects.popper,
